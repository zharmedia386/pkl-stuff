...
navbar = dbc.Navbar(
            dbc.Container(
                [
                    dbc.Row([
                        dbc.Col([
                            html.Img(src=dash.get_asset_url('logo_phl.png'), height="40px"),
                            dbc.NavbarBrand("Dashboard Pengelolaan Hutan Lestari (PHL)", className="ms-2")
                        ],
                        width={"size":"auto"})
                    ],
                    align="center",
                        ...
                        dbc.Col([
                            dbc.Nav([
                                ...
                                dbc.NavItem(dbc.DropdownMenu(
                                        children=[
                                            dbc.DropdownMenuItem("Sub-Case1", href="/sub-case-1"),
                                            dbc.DropdownMenuItem("Sub-Case2", href="/sub-case-2"),
                                            dbc.DropdownMenuItem("Sub-Case3", href="/sub-case-3"),
                                        ],
                                        nav=True,
                                        in_navbar=True,
                                        label="Pages",
