...
datatable = html.Div([
    html.Div([
        ...
        dbc.Button("Add Column", id='adding-columns-button', n_clicks=0, color="primary", className="me-1"),
    ], style={'height': 50}),
    ...
    dbc.Button("Add Row", id='editing-rows-button', n_clicks=0, color="primary", className="me-1"),
