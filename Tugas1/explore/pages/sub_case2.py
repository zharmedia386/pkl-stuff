...
kayu_bulat_grouped_by_provinsi_sorted = kayu_bulat_grouped_by_provinsi.sort_values(by='volume', ascending=False)
...
kayu_bulat_grouped_by_jenis = data_kayu_bulat.groupby('kelompok')['volume'].sum().reset_index()

# Set the desired formatting for the values
pd.options.display.float_format = '{:,.2f}'.format

# Sort the values in descending order
kayu_bulat_grouped_by_jenis_sorted = kayu_bulat_grouped_by_jenis.sort_values(by='volume', ascending=False)

# Rename the columns
kayu_bulat_grouped_by_jenis_sorted = kayu_bulat_grouped_by_jenis_sorted.rename(columns={'kelompok': 'Jenis Kayu', 'volume': 'Nilai Produksi'})
...
# Sort the values in descending order
ekspor_grouped_by_provinsi_sorted = ekspor_grouped_by_provinsi.sort_values(by='value usd', ascending=False)

# Rename the columns
ekspor_grouped_by_provinsi_sorted = ekspor_grouped_by_provinsi_sorted.rename(columns={'provinsi': 'Provinsi', 'value usd': 'Nilai Ekspor'})
...
# Sort the values in descending order
ekspor_grouped_by_jenis_sorted = ekspor_grouped_by_jenis.sort_values(by='value usd', ascending=False)

# Rename the columns
ekspor_grouped_by_jenis_sorted = ekspor_grouped_by_jenis_sorted.rename(columns={'produk': 'Jenis Produk', 'value usd': 'Nilai Ekspor'})
...
def update_table_pagination(page_current, page_size):
    ...
    table_data = kayu_bulat_grouped_by_provinsi_sorted.iloc[start_index:end_index].to_dict('records')
...
def update_table_pagination(page_current, page_size):
    ...
    table_data = ekspor_grouped_by_provinsi_sorted.iloc[start_index:end_index].to_dict('records')
